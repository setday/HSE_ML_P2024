...
class GameScene:
    def __init__(self):
        ...
        self.traffic_cones.append(ObjectFactory.create_object(
            self.render_group, self.space, 'movable_obstacle', (70 * -5 - 35, -70),
            movable_obstacle_model='cone'
        ))
        self.traffic_cones.append(ObjectFactory.create_object(
            self.render_group, self.space, 'movable_obstacle', (70 * -5 - 40, -100),
            movable_obstacle_model='cone'
        ))
        self.traffic_cones.append(ObjectFactory.create_object(
            self.render_group, self.space, 'movable_obstacle', (70 * -5 - 35, -130),
            movable_obstacle_model='cone'
        ))

        self.traffic_cones.append(ObjectFactory.create_object(
            self.render_group, self.space, 'movable_obstacle', (70 * 4 + 35, -70),
            movable_obstacle_model='cone'
        ))
        self.traffic_cones.append(ObjectFactory.create_object(
            self.render_group, self.space, 'movable_obstacle', (70 * 4 + 40, -100),
            movable_obstacle_model='cone'
        ))
        self.traffic_cones.append(ObjectFactory.create_object(
            self.render_group, self.space, 'movable_obstacle', (70 * 4 + 35, -130),
            movable_obstacle_model='cone'
        ))

        for i in range(-5, 5):
            ObjectFactory.create_object(
                self.top_render_group, self.space, 'static_obstacle', (70 * i, -10),
        ...
        for i in range(-5, 4):
            ObjectFactory.create_object(
                self.render_group, self.space, 'static_obstacle', (70 * i + 35, -100), 90,
                static_obstacle_model='metal_pipe'
            )
        for i in range(-5, 5):
            ObjectFactory.create_object(
                self.render_group, self.space, 'static_obstacle', (70 * i, -45),
        ...
        ObjectFactory.create_object(
            self.render_group, self.space, 'static_obstacle', (0, 1000),
            static_obstacle_model='x_barrier'
        )
        ObjectFactory.create_object(
            self.render_group, self.space, 'static_obstacle', (0, -2000),
            static_obstacle_model='x_barrier'
        )
        ObjectFactory.create_object(
            self.render_group, self.space, 'static_obstacle', (3500, 0),
