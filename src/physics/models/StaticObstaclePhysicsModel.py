...
class StaticObstaclePhysicsModel:
    def __init__(
        ...
        if shape_type == "circle":
            self.shape: pymunk.shapes = pymunk.shapes.Circle(self.body, size)
        elif shape_type == "polygon":
            self.shape: pymunk.shapes = pymunk.shapes.Poly(
                self.body, collision_points_set
            )
        elif shape_type == "x_barrier":
            self.shape: pymunk.shapes = pymunk.shapes.Segment(
